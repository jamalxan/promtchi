...
"uz": dict(
    ...
    meta="promtchi — Toshkentdagi IT agentlik va raqamli mahsulotlar studiyasi (2023 yildan). Veb-sayt, mobil ilova, CRM/ERP va AI yechimlar ishlab chiqamiz.",
    h1="Biz haqimizda",
    lead="promtchi — 2023-yildan Toshkentda faoliyat yuritayotgan IT agentlik va raqamli mahsulotlar studiyasi. Bizneslar uchun veb-sayt, mobil ilova, AI yechimlar va CRM/ERP tizimlarini MVP'dan (14 kunda) to'liq mahsulotgacha ishlab chiqamiz — startaplar uchun ishonchli texnik hamkor.",
    mission="Bizning maqsadimiz — shunchaki sayt yoki ilova emas, balki biznesning raqamli transformatsiyasiga xizmat qiladigan, real daromad va samaradorlik olib keladigan tizimlar qurish. Har bir loyihada dizayn, kod va avtomatlashtirishni bitta uzluksiz jarayonga birlashtiramiz.",
    ...
    entity_qa=[
        ("Promtchi nima?", "promtchi — 2023-yildan Toshkentda faoliyat yuritayotgan IT agentlik va raqamli mahsulotlar studiyasi. Bizneslar uchun veb-sayt, mobil ilova, AI yechimlar va CRM/ERP tizimlarini ishlab chiqamiz."),
        ("Promtchi qayerda joylashgan?", "Studiya Toshkentda (O'zbekiston) joylashgan va Toshkent hamda butun O'zbekiston bo'ylab mijozlar bilan ishlaydi — IT autsorsing sifatida ham ishlaymiz."),
...
"ru": dict(
    ...
    meta="promtchi — IT-агентство и студия цифровых продуктов в Ташкенте (с 2023 года). Разработка сайтов, мобильных приложений, CRM/ERP и AI-решений.",
    h1="О нас",
    lead="promtchi — студия цифровых продуктов и IT-агентство, работающее в Ташкенте с 2023 года. Разрабатываем сайты, мобильные приложения, AI-решения и CRM/ERP системы для бизнеса — от MVP (за 14 дней) до готового продукта, как технический партнёр для стартапа.",
    mission="Наша цель — не просто сайт или приложение, а система для цифровой трансформации бизнеса, приносящая реальный доход и эффективность. В каждом проекте мы объединяем дизайн, код и автоматизацию в единый непрерывный процесс.",
    ...
    entity_qa=[
        ("Что такое promtchi?", "promtchi — IT-агентство и студия цифровых продуктов, работающая в Ташкенте с 2023 года. Разрабатываем сайты, мобильные приложения, AI-решения и CRM/ERP системы для бизнеса."),
        ("Где находится promtchi?", "Студия находится в Ташкенте (Узбекистан) и работает с клиентами в Ташкенте и по всему Узбекистану — в том числе как IT-аутсорсинг команда разработчиков."),
...
"en": dict(
    ...
    meta="promtchi is an IT agency and digital product studio in Tashkent (since 2023). We build websites, mobile apps, CRM/ERP systems and AI solutions.",
    h1="About Us",
    lead="promtchi is a digital product studio and IT agency operating in Tashkent since 2023. We build websites, mobile apps, AI solutions and CRM/ERP systems for businesses — from MVP (in 14 days) to a finished product, as a technical partner for startups.",
    mission="Our goal isn't just a website or an app — it's a system that drives real digital transformation for your business, bringing real revenue and efficiency. On every project we unite design, code and automation into one continuous process.",
    ...
    entity_qa=[
        ("What is promtchi?", "promtchi is an IT agency and digital product studio operating in Tashkent since 2023. We build websites, mobile apps, AI solutions and CRM/ERP systems for businesses."),
        ("Where is promtchi located?", "The studio is based in Tashkent (Uzbekistan) and works with clients in Tashkent and across Uzbekistan — also available as an IT outsourcing team."),

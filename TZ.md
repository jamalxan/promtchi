...
**Qolgan — QOLGAN ISHLARNING BARCHASI BIZNES MA'LUMOTIGA BOG'LIQ, texnik jihatdan bajarib bo'lmaydi:**
- Business sign-off: statistika (32/24/98%/3yr), portfolio natijalari, FAQ javoblari, "3 oy bepul support" shartlari, jamoa bio/foto/LinkedIn — kelsa, `app/content/about.py`ga real profil qo'shish va Content.team'ni qayta yoqish mumkin.
- LocalBusiness schema — aniq manzil/ish vaqti kelgach qo'shiladi.
- Homepage (`static/index*.html`) 3 tilda qo'lda yozilgan, DB/CMS'ga bog'lanmagan — RU/EN UZ'dan orqada qolish xavfi hamon bor (bu — Content'ni to'liq trilingual CMS'ga o'tkazish, yirik arxitektura o'zgarishi; joriy sessiyada faqat mavjud manbalar orasidagi kontent nomuvofiqligi va crawl-havolalar tuzatildi, to'liq CMS ko'chirish keyingi bosqichga qoldirildi).
